...
\title{Development of a metamaterial coating for broadband monostatic and bistatic rcs reduction.}
%
%
...
\author{Umrath~Stefan,
        Andrey~Osipov,~\IEEEmembership{Senior Member,~IEEE,}
        and~Erich~Kemptner% <-this % stops a space
...
of a thin, slightly lossy and grounded substrate has been designed and fab-
ricated to experimentally evaluate the performance of the coating in scattering 
reduction. The scattering reduction is estimated by comparing the
