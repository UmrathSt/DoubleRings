...
\usepackage[backref=true,backend=bibtex,natbib=true,hyperref=true, style=numeric, sorting=none]{biblatex}
...
\newcommand{\wing}[3]{
\pgfmathsetmacro{\L1}{{#1}}
\pgfmathsetmacro{\L2}{{#2}}
\pgfmathsetmacro{\L}{\L1-\L2}
\draw[fill=blue!35] (-\L1/2,-\L1/2) -- (-\L1/2, \L1/2) -- (\L, \L1/2) -- (\L1/2,\L) -- (\L1/2,-\L1/2) -- cycle;
}
