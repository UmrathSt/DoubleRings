...
%  \pgfmathsetmacro{\s}{4.6}
%  \draw[fill=blue!35] (-2,-2) -- (-2, 2) -- (1, 2) -- (2,1) -- (2,-2) -- cycle;
%  \draw[fill=blue!35] (-2+\s,-2) -- (2+\s, -2) -- (2+\s, 2) -- (-1+\s,2) -- (-2+\s,1) -- cycle;
%  \draw[fill=blue!35] (-2,-2+\s) -- (-2,2+\s) -- (2, 2+\s) -- (2,-1+\s) -- (1,-2+\s) -- cycle;
%  \draw[fill=blue!35] (-2+\s,-1+\s) -- (-2+\s,2+\s) -- (2+\s,2+\s) -- (2+\s,-2+\s) -- (-1+\s,-2+\s) -- cycle;
% \end{scope}
%\end{tikzpicture}
%\end{figure}
\begin{figure}
\centering
\begin{tikzpicture}
    \begin{scope}[scale=0.5,shift={(0,5.96)},rotate around={-45:(-2,2)}] % Oben
    \coordinate(A) at (-2,-2);
    \coordinate(B) at (1,-2);
    \coordinate(C) at (2,-1);
    \coordinate(D) at (2,2);
    ...
    \begin{scope}[scale=0.5,shift={(-5.96,0)},rotate around={45:(-2,2)}] % Links
    \coordinate(A) at (-2,-2);
    \coordinate(B) at (1,-2);
    \coordinate(C) at (2,-1);
    \coordinate(D) at (2,2);
    ...
    \begin{scope}[scale=0.5,shift={(0,-5.96)},rotate around={135:(-2,2)}] % Unten
    \coordinate(A) at (-2,-2);
    \coordinate(B) at (1,-2);
    \coordinate(C) at (2,-1);
    \coordinate(D) at (2,2);
    ...
    \draw[fill=yellow!90]
        (A) -- (B) -- (C) -- (D) -- (E) -- cycle;
    \end{scope}
    \begin{scope}[scale=0.5,shift={(5.96,0)},rotate around={225:(-2,2)}] % Rechts
    \coordinate(A) at (-2,-2);
    \coordinate(B) at (1,-2);
    \coordinate(C) at (2,-1);
    \coordinate(D) at (2,2);
    ...
    \draw[fill=yellow!90]
        (A) -- (B) -- (C) -- (D) -- (E) -- cycle;
    \end{scope}
    \begin{scope}[scale=0.5,shift={(0,0.5)}]
    \draw[fill=yellow!90]
        (-2.5,2) -- (-1.5,2) -- (-1.5,1) -- (-2.5,1) -- cycle;
    \end{scope}
    % first resistor inside left
    \begin{scope}[scale=0.5,shift={(-0.75,0.25)}]
    \draw[fill=black]
        (-2.5,2) -- (-1.5,2) -- (-1.5,1.5) -- (-2.5,1.5) -- cycle;
    \end{scope}
    % inside right
    \begin{scope}[scale=0.5,shift={(-3.25,0.25)}]
    \draw[fill=black]
        (2.5,2) -- (1.5,2) -- (1.5,1.5) -- (2.5,1.5) -- cycle;
    \end{scope}
    % inside top
    \begin{scope}[scale=0.5,shift={(-2,2)}]
    \draw[fill=black]
        (-0.25,0.25) -- (0.25,0.25) -- (0.25,1.25) -- (-0.25,1.25) -- cycle;
    \end{scope}
    % inside bottom
    \begin{scope}[scale=0.5,shift={(-2,2)}]
    \draw[fill=black]
    ...
    \end{scope}
    % outside right top
    \begin{scope}[scale=0.5,shift={(-2,2)}, rotate around={45:(0,0)},shift={(2,0.75)}]
    \draw[fill=black]
        (-0.25,-0.25) -- (0.25,-0.25) -- (0.25,-1.25) -- (-0.25,-1.25) -- cycle;
    \end{scope}
    % outside left bottom
...
\capEref{eqn:2layerGamma} can be generalized for structures with more than one layer and in general becomes:
\begin{equation}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{Bilder/EC_vs_openEMS.pdf}
...
%\centering
%\begin{tikzpicture}
%\path[fill=yellow] (0,0) -- (3,0) -- (3,3) -- (0,3) -- cycle;
%\path[fill=orange] (0.2,0.2) -- (2.8,0.2) -- (2.8,2.8) -- (0.2,2.8) -- cycle;
%\fill[fill=yellow] (1.5,1.5) circle (1);
%\end{tikzpicture}
