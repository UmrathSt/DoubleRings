...
\usepackage[backref=true,backend=biber,natbib=true,hyperref=true, 
...
\newcommand{\capCref}[1]{Fig. \ref{#1}\textcolor{RoyalBlue}{)}}
\newcommand{\Ref}[1]{\ref{#1}\textcolor{RoyalBlue}{)}}
\newcommand{\unitv}[1]{\hat{\bm{#1}}}
\newcommand{\imag}{\mathrm{i}}
\newcommand{\euler}{\mathrm{e}}
\newcommand{\dyad}[1]{\overset{\bm\leftrightarrow}{#1}}
